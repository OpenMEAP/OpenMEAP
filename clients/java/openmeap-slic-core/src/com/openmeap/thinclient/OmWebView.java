...
public interface OmWebView {
	...
	static public String UPDATE_ERROR = INSURE_OPENMEAP+"window.OpenMEAP.data.update={error:%s};window.OpenMEAP.updates.onInit();";
	static public String UPDATE_NOT_NULL = INSURE_OPENMEAP+"window.OpenMEAP.data.update=%s;window.OpenMEAP.updates.onInit();";
	static public String UPDATE_NULL = INSURE_OPENMEAP+"window.OpenMEAP.data.update=null;window.OpenMEAP.updates.onInit();";

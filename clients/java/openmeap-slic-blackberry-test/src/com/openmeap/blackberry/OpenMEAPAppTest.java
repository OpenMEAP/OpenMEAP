 ...
 */
public class OpenMEAPAppTest extends OpenMEAPApp implements ScreenUiEngineAttachedListener
{
	...
	public void onScreenUiEngineAttached(Screen screen, boolean attached) {
		if(attached) {
			...
			//this.screen.wrap("<div style=\"width:100%;height:100%;overflow:scroll;\">","</div>");
		}
	}    
}
